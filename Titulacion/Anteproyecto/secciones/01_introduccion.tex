...
La disponibilidad de genomas completos provenientes de distintos organismos para su análisis comparativo provee una nueva perspectiva sobre las relaciones homólogas entre los genes \parencite{Koonin_2005}. Tener un inventario conocido de genes conservados responsables de las funciones de gestión interna en la célula y entender la base genética en las diferencias de estas funciones a través de distintos linajes es central para entender la vida misma, al menos a un nivel de célula individual \parencite{Tatusov_1997}. \textcite{Koonin_2005} plantea que debería ser posible entonces reconstruir la historia evolutiva de cada gen (siempre y cuando se tenga secuenciado todo el genoma que lo contenga). \underline{Y a su vez ha tenido el efecto de reintroducir un significado mas amplio de familia génica para incluir a los genes parálogos dentro de una especie y genes ortólogos o parálogos entre distintas especies.}
 ...
 A la par del descubrimiento toda esta nueva información, es bastante natural extenderle conceptos de biología evolutiva, principalmente, definiciones como: homología, ortología y paralogía. 
